...
{ //----  返却処理
  // &(*b0)でb0を実引数に
  return bignum_mlt1(b1, b2, b0);    // 畳込法による実装
  // return bignum_mlt2(b1, b2, b0);    // カラツバ法による実装
}

//--------------------------------------------------------------------
//  畳込法による多倍長整数の多倍長整数による乗算
//--------------------------------------------------------------------

Bool bignum_mlt1(BigNum b1, BigNum b2, BigNum *b0)
{
  //----  局所宣言
  int c;             // 繰上り
  int k1, k2, k0;    // 反復変数
